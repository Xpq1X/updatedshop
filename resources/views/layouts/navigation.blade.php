<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700 fixed top-0 w-full z-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <!-- Flex container for login on the left and search on the right -->
            <div class="flex items-center ml-auto space-x-4">
                <!-- User Dropdown (left of the search bar) -->
                ...
                <form method="GET" action="{{ route('products.search') }}" class="relative flex">
                    <input type="text" name="query" placeholder="Search..." class="border rounded-md p-2 text-black" />
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600 text-black">
            <div class="px-4">
                <div class="font-medium text-base text-black dark:text-gray-200">{{ Auth::user()->name ?? __('Guest') }}</div>
